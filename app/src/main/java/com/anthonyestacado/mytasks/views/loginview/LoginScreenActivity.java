...
public class LoginScreenActivity extends AppCompatActivity implements LoginScreenActivityInterface, View.OnClickListener {

    private LoginScreenPresenterInterface presenter;
