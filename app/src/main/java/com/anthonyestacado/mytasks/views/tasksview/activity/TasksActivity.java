...
import com.anthonyestacado.mytasks.views.tasksview.fragments.usertaskdetails.UserTaskDetailsFragment;

public class TasksActivity extends AppCompatActivity
                           implements NavigationView.OnNavigationItemSelectedListener,
                                      TasksActivityInterface {

    private TasksActivityPresenterInterface presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new TasksActivityPresenter(this, this);
    ...
    public void loadUserTasksListFragmentByCriteria(Tasks criteria) {
        ...
        switch (criteria) {
            case ALL: {
                bundleForFragment.putString("criteria", "All tasks");
                break;
            }
            case IN_PROGRESS: {
                bundleForFragment.putString("criteria", "In progress");
                break;
            }
            case DONE: {
                bundleForFragment.putString("criteria", "Done tasks");
